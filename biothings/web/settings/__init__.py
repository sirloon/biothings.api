...
class BiothingWebSettings(object):
    ...
    def generate_app_list(self, reverse=False):
        ...
        if reverse:
            return INITIALIZED_APP_LIST + self.UNINITIALIZED_APP_LIST
        return self.UNINITIALIZED_APP_LIST + INITIALIZED_APP_LIST
